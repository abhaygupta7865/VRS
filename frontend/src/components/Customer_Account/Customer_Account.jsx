    ...
    <div className='container mt-4'>
      <div className='h-full min-h-full overflow-auto p-2 font-sans bg-white'>
        <div className='flex justify-between max-w-7xl w-full mx-auto p-4 gap-4'>
          {userDetails && (
            <div  key={userDetails.customer_id} className=' rounded-md border border-yellow-500 shadow-xl shadow-black text-sm w-1/3 px-4 py-8 bg-white'>
          ...
          <div className='rounded-lg w-3/4 mt-0 p-0 mb-0 bg-white border border-yellow-500 shadow-xl shadow-black text-sm'>
            <p className='font-bold text-center rounded-lg text-uppercase text-3xl border-b border-yellow-500 py-4 text-white bg-yellow-500'>My Account</p>
              ...
              <div className='text-sm font-sans antialiased'>
                ...
                <div className="p-4 rounded mt-4 font-sm">
                  ...
                  <div className="flex mt-2">
                    ...
                    <input id="mobile" type="text" className="block w-52 h-8 px-3 py-2 text-base leading-tight bg-white border border-yellow-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-yellow-300 hover:border-yellow-500" placeholder={userDetails && userDetails.customer_mobile_number} />
                  </div>
                </div>
                {/*Personal Details*/}
                <div className="m-4">
                  ...
                  <div className="flex">
                    ...
                    <div className="w-1/2">
                      <div className="flex mt-4">
                        ...
                        <select name="user[gender]" id="gender" className="antialiased box-border block w-52 h-10 px-4 py-2 text-base leading-tight text-yellow-500 bg-white border border-yellow-500 rounded-md max-w-xs mr-3 hover:border-yellow-500">
                          <option value="male" className="bg-white text-yellow-500 hover:bg-yellow-500">Male</option>
                          <option value="female" className="bg-white text-yellow-500 hover:bg-yellow-700">female</option>
                        </select>
                      </div>
                    </div>
                  </div>
                ...
                <div className="m-4">
                  ...
                  <div className="flex mt-4">
                    ...
                    <select name="city" id="city" className="antialiased box-border block w-52 h-10 px-4 py-2 text-base leading-tight text-yellow-500 bg-white border border-gray-300 rounded-md max-w-xs mr-3 hover:border-yellow-700 ml-11">
                      <option value="bhopal" className="bg-white text-yellow-500 hover:bg-yellow-500">Bhopal</option>
                      <option value="indore" className="bg-white text-yellow-500 hover:bg-yellow-500">Indore</option>
                      <option value="delhi" className="bg-white text-yellow-500 hover:bg-yellow-500">Delhi</option>
                    </select>
                  </div>
                </div>
                <div className="flex justify-center mt-20">
                  <button className=" font-bold rounded-xl bg-yellow-500 text-white p-2 w-40 text-xl hover:bg-yellow-300">UPDATE</button>
                </div>
              </div>
            </div>
          </div>
